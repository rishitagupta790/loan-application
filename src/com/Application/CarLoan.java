...
public class CarLoan extends Loan {
	...
	public CarLoan(Scanner sc) {
        ...
        String[] values= {"Car Loan","EMI:"+emi*interestAmount,"Time:"+super.getTime(),"Amount:"+super.getAmount(),"Rate:"+super.getRate()};
